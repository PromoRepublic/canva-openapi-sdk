...
class Folder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets created_at
     *
     * @param int $created_at When the folder was created, as a Unix timestamp (in seconds since the Unix Epoch).
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param int $updated_at When the folder was last updated, as a Unix timestamp (in seconds since the Unix Epoch).
     *
     * @return self
     */
