 ...
 */
class GetDesignImportJobResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetDesignImportJobResponse';
    ...
    */
     ...
     * Sets job_id
     *
     * @param string $job_id The design import job ID.
     *
     * @return self
     */
    ...
    {
        if (is_null($designs)) {
            throw new \InvalidArgumentException('non-nullable designs cannot be null');
        }
