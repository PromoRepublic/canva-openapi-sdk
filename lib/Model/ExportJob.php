 ...
 */
class ExportJob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExportJob';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The export job ID.
     *
     * @return self
     */
     ...
     * Sets urls
     *
     * @param string[]|null $urls When the export job is completed, also returns a list of urls for the exported resources. The list is sorted by page order.
     *
     * @return self
     */
