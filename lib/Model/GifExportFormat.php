...
/**
 * GifExportFormat Class Doc Comment
 *
 * @category Class
 ...
 */
class GifExportFormat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GifExportFormat';
    ...
    */
    ...
    public function setHeight($height)
    {
        ...
        if (($height > 25000)) {
            throw new \InvalidArgumentException('invalid value for $height when calling GifExportFormat., must be smaller than or equal to 25000.');
        }
        if (($height < 40)) {
            throw new \InvalidArgumentException('invalid value for $height when calling GifExportFormat., must be bigger than or equal to 40.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (($width > 25000)) {
            throw new \InvalidArgumentException('invalid value for $width when calling GifExportFormat., must be smaller than or equal to 25000.');
        }
        if (($width < 40)) {
            throw new \InvalidArgumentException('invalid value for $width when calling GifExportFormat., must be bigger than or equal to 40.');
        }
