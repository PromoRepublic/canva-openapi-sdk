...
/**
 * JpgExportFormat Class Doc Comment
 *
 * @category Class
 ...
 */
class JpgExportFormat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JpgExportFormat';
    ...
    */
    ...
    public function setQuality($quality)
    {
        ...
        if (($quality > 100)) {
            throw new \InvalidArgumentException('invalid value for $quality when calling JpgExportFormat., must be smaller than or equal to 100.');
        }
        if (($quality < 1)) {
            throw new \InvalidArgumentException('invalid value for $quality when calling JpgExportFormat., must be bigger than or equal to 1.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (($height > 25000)) {
            throw new \InvalidArgumentException('invalid value for $height when calling JpgExportFormat., must be smaller than or equal to 25000.');
        }
        if (($height < 40)) {
            throw new \InvalidArgumentException('invalid value for $height when calling JpgExportFormat., must be bigger than or equal to 40.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (($width > 25000)) {
            throw new \InvalidArgumentException('invalid value for $width when calling JpgExportFormat., must be smaller than or equal to 25000.');
        }
        if (($width < 40)) {
            throw new \InvalidArgumentException('invalid value for $width when calling JpgExportFormat., must be bigger than or equal to 40.');
        }
