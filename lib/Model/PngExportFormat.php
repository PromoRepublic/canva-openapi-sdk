 ...
 */
class PngExportFormat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PngExportFormat';
    ...
    */
    ...
    public function setHeight($height)
    {
        ...
        if (($height > 25000)) {
            throw new \InvalidArgumentException('invalid value for $height when calling PngExportFormat., must be smaller than or equal to 25000.');
        }
        if (($height < 40)) {
            throw new \InvalidArgumentException('invalid value for $height when calling PngExportFormat., must be bigger than or equal to 40.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (($width > 25000)) {
            throw new \InvalidArgumentException('invalid value for $width when calling PngExportFormat., must be smaller than or equal to 25000.');
        }
        if (($width < 40)) {
            throw new \InvalidArgumentException('invalid value for $width when calling PngExportFormat., must be bigger than or equal to 40.');
        }
