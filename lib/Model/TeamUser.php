 ...
 */
class TeamUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets team_id
     *
     * @param string|null $team_id The ID of the user's Canva Team.
     *
     * @return self
     */
     ...
     * Sets display_name
     *
     * @param string|null $display_name The name of the user as shown in the Canva UI.
     *
     * @return self
     */
