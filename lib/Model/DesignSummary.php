 ...
 */
class DesignSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DesignSummary';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The design ID.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url URL of the design.
     *
     * @return self
     */
