 ...
 */
class DesignLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DesignLinks';
    ...
    */
     ...
     * Sets edit_url
     *
     * @param string $edit_url A temporary editing URL for the design.  NOTE: This is not a permanent URL, it is only valid for 30 days.
     *
     * @return self
     */
     ...
     * Sets view_url
     *
     * @param string $view_url A temporary viewing URL for the design.  NOTE: This is not a permanent URL, it is only valid for 30 days.
     *
     * @return self
     */
