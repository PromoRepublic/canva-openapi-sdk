...
class Asset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets created_at
     *
     * @param int $created_at When the asset was added to Canva, as a Unix timestamp (in seconds since the Unix Epoch).
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param int $updated_at When the asset was last updated in Canva, as a Unix timestamp (in seconds since the Unix Epoch).
     *
     * @return self
     */
