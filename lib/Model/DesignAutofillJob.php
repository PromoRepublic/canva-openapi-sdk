 ...
 */
class DesignAutofillJob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DesignAutofillJob';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id ID of the asynchronous job that is creating the design using the provided data.
     *
     * @return self
     */
