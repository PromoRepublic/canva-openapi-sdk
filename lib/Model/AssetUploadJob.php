 ...
 */
class AssetUploadJob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetUploadJob';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The ID of the asset upload job.
     *
     * @return self
     */
