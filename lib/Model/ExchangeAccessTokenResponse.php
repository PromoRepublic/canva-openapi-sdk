...
/**
 * ExchangeAccessTokenResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ExchangeAccessTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExchangeAccessTokenResponse';
    ...
    */
     ...
     * Sets access_token
     *
     * @param string $access_token The bearer access token to use to authenticate to Canva Connect API endpoints. If requested using a `authorization_code` or `refresh_token`, this allows you to act on behalf of a user.
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string $refresh_token The token that you can use to refresh the access token.
     *
     * @return self
     */
     ...
     * Sets token_type
     *
     * @param string $token_type The token type returned. This is always `Bearer`.
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int $expires_in The expiry time (in seconds) for the token.
     *
     * @return self
     */
