...
/**
 * DatasetValue Class Doc Comment
 *
 * @category Class
 ...
 */
class DatasetValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DatasetValue';
    ...
    */
     ...
     * Sets asset_id
     *
     * @param string $asset_id `asset_id` of the image to insert into the template element.
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string $text Text to insert into the template element.
     *
     * @return self
     */
