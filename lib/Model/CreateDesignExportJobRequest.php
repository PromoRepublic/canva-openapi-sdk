 ...
 */
class CreateDesignExportJobRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateDesignExportJobRequest';
    ...
    */
     ...
     * Sets design_id
     *
     * @param string $design_id The design ID.
     *
     * @return self
     */
