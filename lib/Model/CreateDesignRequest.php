 ...
 */
class CreateDesignRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateDesignRequest';
    ...
    */
     ...
     * Sets asset_id
     *
     * @param string|null $asset_id The ID of an asset to insert into the created design.
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title The name of the design. Must be less than 256 characters.
     *
     * @return self
     */
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CreateDesignRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CreateDesignRequest., must be bigger than or equal to 1.');
        }
