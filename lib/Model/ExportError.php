 ...
 */
class ExportError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExportError';
    ...
    */
     ...
     * Sets message
     *
     * @param string|null $message A human-readable description of what went wrong.
     *
     * @return self
     */
