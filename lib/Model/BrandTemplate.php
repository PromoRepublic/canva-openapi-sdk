...
class BrandTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['create_url'] === null) {
            $invalidProperties[] = "'create_url' can't be null";
        }
     ...
     * Sets id
     *
     * @param string $id The brand template ID.
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string $title The brand template title, as shown in the Canva UI.
     *
     * @return self
     */
     ...
     * Sets view_url
     *
     * @param string $view_url A URL Canva users can visit to view the brand template.
     *
     * @return self
     */
     ...
     * Sets create_url
     *
     * @param string $create_url A URL Canva users can visit to create a new design from the template.
     *
     * @return self
     */
