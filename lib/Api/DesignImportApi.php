...
class DesignImportApi
{
     ...
     *
     * @param  DesignImportMetadata $import_metadata import_metadata (required)
    ...
    {
        list($response) = $this->createDesignImportJobWithHttpInfo($import_metadata, $body, $contentType);
        return $response;
    }

    /**
     * Operation createDesignImportJobWithHttpInfo
     *
     * @param  DesignImportMetadata $import_metadata (required)
     * @param  \SplFileObject $body Binary of the file to import. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createDesignImportJob'] to see the possible values for this operation
     *
     * @throws \Integrations\Canva\SDK\ApiException on non-2xx response or if the response body is not in the expected format
    ...
    /**
     * Operation createDesignImportJobAsync
     *
     * @param  DesignImportMetadata $import_metadata (required)
     * @param  \SplFileObject $body Binary of the file to import. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createDesignImportJob'] to see the possible values for this operation
     ...
     */
    public function createDesignImportJobAsync($import_metadata, $body, string $contentType = self::contentTypes['createDesignImportJob'][0])
    {
        return $this->createDesignImportJobAsyncWithHttpInfo($import_metadata, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createDesignImportJobAsyncWithHttpInfo
     *
     * @param  DesignImportMetadata $import_metadata (required)
     * @param  \SplFileObject $body Binary of the file to import. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createDesignImportJob'] to see the possible values for this operation
    ...
    /**
     * Create request for operation 'createDesignImportJob'
     *
     * @param  DesignImportMetadata $import_metadata (required)
     * @param  \SplFileObject $body Binary of the file to import. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createDesignImportJob'] to see the possible values for this operation
     ...
     */
    public function createDesignImportJobRequest($import_metadata, $body, string $contentType = self::contentTypes['createDesignImportJob'][0])
    {

        // verify the required parameter 'import_metadata' is set
        if ($import_metadata === null || (is_array($import_metadata) && count($import_metadata) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $import_metadata when calling createDesignImportJob'
            );
        }
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createDesignImportJob'
            );
        }
        ...
        // header params
        if ($import_metadata !== null) {
            $headerParams['Import-Metadata'] = ObjectSerializer::toHeaderValue($import_metadata);
        }
    ...
    {
        list($response) = $this->getDesignImportJobWithHttpInfo($job_id, $contentType);
        return $response;
    }

    /**
     * Operation getDesignImportJobWithHttpInfo
     *
     * @param  string $job_id The design import job ID. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDesignImportJob'] to see the possible values for this operation
     *
    ...
    /**
     * Operation getDesignImportJobAsync
     *
     * @param  string $job_id The design import job ID. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDesignImportJob'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDesignImportJobAsync($job_id, string $contentType = self::contentTypes['getDesignImportJob'][0])
    {
        return $this->getDesignImportJobAsyncWithHttpInfo($job_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDesignImportJobAsyncWithHttpInfo
     *
     * @param  string $job_id The design import job ID. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDesignImportJob'] to see the possible values for this operation
     *
    ...
    /**
     * Create request for operation 'getDesignImportJob'
     *
     * @param  string $job_id The design import job ID. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDesignImportJob'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDesignImportJobRequest($job_id, string $contentType = self::contentTypes['getDesignImportJob'][0])
    {

        // verify the required parameter 'job_id' is set
        if ($job_id === null || (is_array($job_id) && count($job_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $job_id when calling getDesignImportJob'
            );
        }
        if (!preg_match("/^[a-zA-Z0-9_-]{1,50}$/", $job_id)) {
            throw new \InvalidArgumentException("invalid value for \"job_id\" when calling DesignImportApi.getDesignImportJob, must conform to the pattern /^[a-zA-Z0-9_-]{1,50}$/.");
        }
        

        $resourcePath = '/v1/imports/{jobId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
