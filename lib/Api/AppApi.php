...
class AppApi
{
    ...
    {
        list($response) = $this->getAppJwksWithHttpInfo($app_id, $contentType);
        return $response;
    }

    /**
     * Operation getAppJwksWithHttpInfo
     *
     * @param  string $app_id The app id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAppJwks'] to see the possible values for this operation
     *
     ...
     */
    public function getAppJwksAsync($app_id, string $contentType = self::contentTypes['getAppJwks'][0])
    {
        return $this->getAppJwksAsyncWithHttpInfo($app_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAppJwksAsyncWithHttpInfo
     *
     * @param  string $app_id The app id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAppJwks'] to see the possible values for this operation
     *
    ...
    /**
     * Create request for operation 'getAppJwks'
     *
     * @param  string $app_id The app id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAppJwks'] to see the possible values for this operation
     *
     ...
     */
    public function getAppJwksRequest($app_id, string $contentType = self::contentTypes['getAppJwks'][0])
    {

        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling getAppJwks'
            );
        }
        if (!preg_match("/^[a-zA-Z0-9_-]{1,50}$/", $app_id)) {
            throw new \InvalidArgumentException("invalid value for \"app_id\" when calling AppApi.getAppJwks, must conform to the pattern /^[a-zA-Z0-9_-]{1,50}$/.");
        }
        

        $resourcePath = '/v1/apps/{appId}/jwks';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
