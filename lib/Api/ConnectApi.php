...
class ConnectApi
{
    ...
    {
        list($response) = $this->getSigningPublicKeysWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation getSigningPublicKeysWithHttpInfo
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSigningPublicKeys'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
    ...
    /**
     * Operation getSigningPublicKeysAsync
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSigningPublicKeys'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function getSigningPublicKeysAsync(string $contentType = self::contentTypes['getSigningPublicKeys'][0])
    {
        return $this->getSigningPublicKeysAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSigningPublicKeysAsyncWithHttpInfo
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSigningPublicKeys'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
    ...
    /**
     * Create request for operation 'getSigningPublicKeys'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSigningPublicKeys'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function getSigningPublicKeysRequest(string $contentType = self::contentTypes['getSigningPublicKeys'][0])
    {


        $resourcePath = '/v1/connect/keys';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
