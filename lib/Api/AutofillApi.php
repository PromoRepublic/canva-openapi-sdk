...
class AutofillApi
{
    ...
    {
        list($response) = $this->createDesignAutofillJobWithHttpInfo($create_design_autofill_job_request, $contentType);
        return $response;
    }
     ...
     */
    public function createDesignAutofillJobAsync($create_design_autofill_job_request = null, string $contentType = self::contentTypes['createDesignAutofillJob'][0])
    {
        return $this->createDesignAutofillJobAsyncWithHttpInfo($create_design_autofill_job_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function createDesignAutofillJobRequest($create_design_autofill_job_request = null, string $contentType = self::contentTypes['createDesignAutofillJob'][0])
    {



        $resourcePath = '/v1/autofills';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($create_design_autofill_job_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \Integrations\Canva\SDK\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_design_autofill_job_request));
            } else {
                $httpBody = $create_design_autofill_job_request;
            }
    ...
    {
        list($response) = $this->getDesignAutofillJobWithHttpInfo($job_id, $contentType);
        return $response;
    }

    /**
     * Operation getDesignAutofillJobWithHttpInfo
     *
     * @param  string $job_id The design autofill job ID. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDesignAutofillJob'] to see the possible values for this operation
     *
    ...
    /**
     * Operation getDesignAutofillJobAsync
     *
     * @param  string $job_id The design autofill job ID. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDesignAutofillJob'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDesignAutofillJobAsync($job_id, string $contentType = self::contentTypes['getDesignAutofillJob'][0])
    {
        return $this->getDesignAutofillJobAsyncWithHttpInfo($job_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDesignAutofillJobAsyncWithHttpInfo
     *
     * @param  string $job_id The design autofill job ID. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDesignAutofillJob'] to see the possible values for this operation
     *
    ...
    /**
     * Create request for operation 'getDesignAutofillJob'
     *
     * @param  string $job_id The design autofill job ID. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDesignAutofillJob'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDesignAutofillJobRequest($job_id, string $contentType = self::contentTypes['getDesignAutofillJob'][0])
    {

        // verify the required parameter 'job_id' is set
        if ($job_id === null || (is_array($job_id) && count($job_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $job_id when calling getDesignAutofillJob'
            );
        }
        if (!preg_match("/^[a-zA-Z0-9_-]{1,50}$/", $job_id)) {
            throw new \InvalidArgumentException("invalid value for \"job_id\" when calling AutofillApi.getDesignAutofillJob, must conform to the pattern /^[a-zA-Z0-9_-]{1,50}$/.");
        }
        

        $resourcePath = '/v1/autofills/{jobId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
